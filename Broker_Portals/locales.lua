...
L["ANNOUNCE"] = "Anunciar el lanzamiento de portales." -- Needs review
L["ANNOUNCEMENT"] = [=[Lanzando
La frase "Lanzando <nombre de hechizo>" se mostrará cuando empiezas abrir un portal.]=] -- Needs review
