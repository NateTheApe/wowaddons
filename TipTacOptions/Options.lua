...
local options = {
	...
	-- Bar Types
	{
		...
		{ type = "Check", var = "barsCondenseValues", label = "Show Condenced Bar Values", tip = "You can enable this option to condense values shown on the bars. It does this by showing 57254 as 57.3k as an example" },
