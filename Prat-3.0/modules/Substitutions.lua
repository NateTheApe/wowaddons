...
L:AddLocale("ruRU",  
{
	...
	["|cffff0000warning:|r subtitution \"%s\" already defined as \"%s\", overwriting"] = "|cffff0000предупреждение:|r замена \"%s\" уже определена как \"%s\", переписываем", -- Needs review
	[ [=[Current value: '%s'
...
Кликнуть для копирования в чат.]=],
	...
	MouseoverTargetName = "ИмяЦелиКурсора", -- Needs review
	["<noguild>"] = "<без гильдии>",
	...
	["substitution: %s defined as => %s"] = "%s определен как => %s", -- Needs review
	...
	["user defined substition \"%s\" not found"] = "пользовательская замена \"%s\" не найдена", -- Needs review
	["User defined substitutions"] = "Пользовательские подмены",
	usersub_ = "ползам_", -- Needs review
	["user substitutions index (usersubs_idx) doesn't exist! oh dear."] = "таблица пользовательских замен (usersubs_idx) не существует! о боже.", -- Needs review
}
