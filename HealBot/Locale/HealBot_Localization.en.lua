...
function HealBot_Lang_enALL()
    ...
    HEALBOT_CUSTOM_DEBUFF_CATS = {
            ...
            [HEALBOT_DARK_BARGAIN]             = 3,
            [HEALBOT_SHROUD_OF_PURGATORY]      = 9,
			}
    ...
    HEALBOT_ABOUT_CREDITD                  = "Acirac, Kubik, Von, Aldetal, Brezza, Moonlight Han Xing, CTShammy, Hermis, Aria"  -- Anyone taking on translations (if required), feel free to add yourself here.
